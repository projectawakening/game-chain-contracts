...
library LocationSystemLib {
  ...
  function saveLocation(CallWrapper memory self, uint256 smartObjectId, LocationData memory locationData) internal {
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("LocationSystem.saveLocation")),
      smartObjectId,
      locationData
    );
    self.from == address(0)
  ...
  function setSolarSystemId(CallWrapper memory self, uint256 smartObjectId, uint256 solarSystemId) internal {
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("LocationSystem.setSolarSystemId")),
      smartObjectId,
      solarSystemId
    );
    self.from == address(0)
  ...
  function setX(CallWrapper memory self, uint256 smartObjectId, uint256 x) internal {
    ...
    bytes memory systemCall = abi.encodeWithSelector(bytes4(keccak256("LocationSystem.setX")), smartObjectId, x);
    self.from == address(0)
      ? _world().call(self.systemId, systemCall)
      : _world().callFrom(self.from, self.systemId, systemCall);
  }
  ...
  function setY(CallWrapper memory self, uint256 smartObjectId, uint256 y) internal {
    ...
    bytes memory systemCall = abi.encodeWithSelector(bytes4(keccak256("LocationSystem.setY")), smartObjectId, y);
    self.from == address(0)
      ? _world().call(self.systemId, systemCall)
      : _world().callFrom(self.from, self.systemId, systemCall);
  }
  ...
  function setZ(CallWrapper memory self, uint256 smartObjectId, uint256 z) internal {
    ...
    bytes memory systemCall = abi.encodeWithSelector(bytes4(keccak256("LocationSystem.setZ")), smartObjectId, z);
    self.from == address(0)
      ? _world().call(self.systemId, systemCall)
      : _world().callFrom(self.from, self.systemId, systemCall);
  }
