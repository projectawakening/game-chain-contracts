...
library SmartTurretSystemLib {
  ...
  function createAndAnchorSmartTurret(
    ...
    return
      CallWrapper(self.toResourceId(), address(0)).createAndAnchorSmartTurret(
        smartObjectId,
        entityRecordData,
        smartObjectData,
        worldPosition,
  ...
  function aggression(
    ...
    return
      CallWrapper(self.toResourceId(), address(0)).aggression(
        smartObjectId,
        turretOwnerCharacterId,
        priorityQueue,
        turret,
  ...
  function createAndAnchorSmartTurret(
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("SmartTurretSystem.createAndAnchorSmartTurret")),
      smartObjectId,
      entityRecordData,
      smartObjectData,
      worldPosition,
  ...
  function configureSmartTurret(CallWrapper memory self, uint256 smartObjectId, ResourceId systemId) internal {
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("SmartTurretSystem.configureSmartTurret")),
      smartObjectId,
      systemId
    );
    self.from == address(0)
  ...
  function inProximity(
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("SmartTurretSystem.inProximity")),
      smartObjectId,
      turretOwnerCharacterId,
      priorityQueue,
      turret,
  ...
  function aggression(
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("SmartTurretSystem.aggression")),
      smartObjectId,
      turretOwnerCharacterId,
      priorityQueue,
      turret,
