...
library SmartAssemblySystemLib {
  ...
  function createSmartAssembly(
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("SmartAssemblySystem.createSmartAssembly")),
      smartObjectId,
      smartAssemblyType,
      entityRecord
    );
  ...
  function setSmartAssemblyType(
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("SmartAssemblySystem.setSmartAssemblyType")),
      smartObjectId,
      smartAssemblyType
    );
    self.from == address(0)
  ...
  function updateSmartAssemblyType(
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("SmartAssemblySystem.updateSmartAssemblyType")),
      smartObjectId,
      smartAssemblyType
    );
    self.from == address(0)
