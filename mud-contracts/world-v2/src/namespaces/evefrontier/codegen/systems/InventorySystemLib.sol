...
library InventorySystemLib {
  ...
  function setInventoryCapacity(CallWrapper memory self, uint256 smartObjectId, uint256 capacity) internal {
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("InventorySystem.setInventoryCapacity")),
      smartObjectId,
      capacity
    );
    self.from == address(0)
  ...
  function createAndDepositItemsToInventory(
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("InventorySystem.createAndDepositItemsToInventory")),
      smartObjectId,
      items
    );
    self.from == address(0)
  ...
  function depositToInventory(CallWrapper memory self, uint256 smartObjectId, InventoryItem[] memory items) internal {
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("InventorySystem.depositToInventory")),
      smartObjectId,
      items
    );
    self.from == address(0)
  ...
  function withdrawFromInventory(
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("InventorySystem.withdrawFromInventory")),
      smartObjectId,
      items
    );
    self.from == address(0)
