...
library EphemeralInventorySystemLib {
  ...
  function setEphemeralInventoryCapacity(
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("EphemeralInventorySystem.setEphemeralInventoryCapacity")),
      smartObjectId,
      ephemeralStorageCapacity
    );
    self.from == address(0)
  ...
  function createAndDepositItemsToEphemeralInventory(
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("EphemeralInventorySystem.createAndDepositItemsToEphemeralInventory")),
      smartObjectId,
      ephemeralInventoryOwner,
      items
    );
  ...
  function depositToEphemeralInventory(
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("EphemeralInventorySystem.depositToEphemeralInventory")),
      smartObjectId,
      ephemeralInventoryOwner,
      items
    );
  ...
  function withdrawFromEphemeralInventory(
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("EphemeralInventorySystem.withdrawFromEphemeralInventory")),
      smartObjectId,
      ephemeralInventoryOwner,
      items
    );
