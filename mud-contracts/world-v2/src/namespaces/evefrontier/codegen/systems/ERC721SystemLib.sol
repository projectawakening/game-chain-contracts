...
library ERC721SystemLib {
  ...
  function balanceOf(CallWrapper memory self, address owner) internal view returns (uint256) {
    ...
    bytes memory systemCall = abi.encodeCall(_balanceOf_address.balanceOf, (owner));
  ...
  function ownerOf(CallWrapper memory self, uint256 tokenId) internal view returns (address) {
    ...
    bytes memory systemCall = abi.encodeCall(_ownerOf_uint256.ownerOf, (tokenId));
    bytes memory worldCall = self.from == address(0)
      ? abi.encodeCall(IWorldCall.call, (self.systemId, systemCall))
      : abi.encodeCall(IWorldCall.callFrom, (self.from, self.systemId, systemCall));
    (bool success, bytes memory returnData) = address(_world()).staticcall(worldCall);
  ...
  function name(CallWrapper memory self) internal view returns (string memory) {
    ...
    bytes memory systemCall = abi.encodeCall(_name.name, ());
    bytes memory worldCall = self.from == address(0)
      ? abi.encodeCall(IWorldCall.call, (self.systemId, systemCall))
      : abi.encodeCall(IWorldCall.callFrom, (self.from, self.systemId, systemCall));
    (bool success, bytes memory returnData) = address(_world()).staticcall(worldCall);
  ...
  function symbol(CallWrapper memory self) internal view returns (string memory) {
    ...
    bytes memory systemCall = abi.encodeCall(_symbol.symbol, ());
    bytes memory worldCall = self.from == address(0)
      ? abi.encodeCall(IWorldCall.call, (self.systemId, systemCall))
      : abi.encodeCall(IWorldCall.callFrom, (self.from, self.systemId, systemCall));
    (bool success, bytes memory returnData) = address(_world()).staticcall(worldCall);
  ...
  function tokenURI(CallWrapper memory self, uint256 tokenId) internal view returns (string memory) {
    ...
    bytes memory systemCall = abi.encodeCall(_tokenURI_uint256.tokenURI, (tokenId));
    bytes memory worldCall = self.from == address(0)
      ? abi.encodeCall(IWorldCall.call, (self.systemId, systemCall))
      : abi.encodeCall(IWorldCall.callFrom, (self.from, self.systemId, systemCall));
    (bool success, bytes memory returnData) = address(_world()).staticcall(worldCall);
  ...
  function approve(CallWrapper memory self, address to, uint256 tokenId) internal {
    ...
    bytes memory systemCall = abi.encodeCall(_approve_address_uint256.approve, (to, tokenId));
    self.from == address(0)
  ...
  function getApproved(CallWrapper memory self, uint256 tokenId) internal view returns (address) {
    ...
    bytes memory systemCall = abi.encodeCall(_getApproved_uint256.getApproved, (tokenId));
    bytes memory worldCall = self.from == address(0)
      ? abi.encodeCall(IWorldCall.call, (self.systemId, systemCall))
      : abi.encodeCall(IWorldCall.callFrom, (self.from, self.systemId, systemCall));
    (bool success, bytes memory returnData) = address(_world()).staticcall(worldCall);
  ...
  function setApprovalForAll(CallWrapper memory self, address operator, bool approved) internal {
    ...
    bytes memory systemCall = abi.encodeCall(_setApprovalForAll_address_bool.setApprovalForAll, (operator, approved));
    self.from == address(0)
      ? _world().call(self.systemId, systemCall)
      : _world().callFrom(self.from, self.systemId, systemCall);
  }
  ...
  function isApprovedForAll(CallWrapper memory self, address owner, address operator) internal view returns (bool) {
    ...
    bytes memory systemCall = abi.encodeCall(_isApprovedForAll_address_address.isApprovedForAll, (owner, operator));
    bytes memory worldCall = self.from == address(0)
      ? abi.encodeCall(IWorldCall.call, (self.systemId, systemCall))
      : abi.encodeCall(IWorldCall.callFrom, (self.from, self.systemId, systemCall));
    (bool success, bytes memory returnData) = address(_world()).staticcall(worldCall);
  ...
  function transferFrom(CallWrapper memory self, address from, address to, uint256 tokenId) internal {
    ...
    bytes memory systemCall = abi.encodeCall(_transferFrom_address_address_uint256.transferFrom, (from, to, tokenId));
    self.from == address(0)
      ? _world().call(self.systemId, systemCall)
      : _world().callFrom(self.from, self.systemId, systemCall);
  }
  ...
  function safeTransferFrom(CallWrapper memory self, address from, address to, uint256 tokenId) internal {
    ...
    bytes memory systemCall = abi.encodeCall(
      _safeTransferFrom_address_address_uint256.safeTransferFrom,
      (from, to, tokenId)
    );
    self.from == address(0)
      ? _world().call(self.systemId, systemCall)
  ...
  function safeTransferFrom(
    ...
    bytes memory systemCall = abi.encodeCall(
      _safeTransferFrom_address_address_uint256_bytes.safeTransferFrom,
  ...
  function mint(CallWrapper memory self, address to, uint256 tokenId) internal {
    ...
    bytes memory systemCall = abi.encodeCall(_mint_address_uint256.mint, (to, tokenId));
    self.from == address(0)
      ? _world().call(self.systemId, systemCall)
      : _world().callFrom(self.from, self.systemId, systemCall);
  }
  ...
  function safeMint(CallWrapper memory self, address to, uint256 tokenId) internal {
    ...
    bytes memory systemCall = abi.encodeCall(_safeMint_address_uint256.safeMint, (to, tokenId));
    self.from == address(0)
      ? _world().call(self.systemId, systemCall)
      : _world().callFrom(self.from, self.systemId, systemCall);
  }
  ...
  function safeMint(CallWrapper memory self, address to, uint256 tokenId, bytes memory data) internal {
    ...
    bytes memory systemCall = abi.encodeCall(_safeMint_address_uint256_bytes.safeMint, (to, tokenId, data));
    self.from == address(0)
      ? _world().call(self.systemId, systemCall)
      : _world().callFrom(self.from, self.systemId, systemCall);
  }
  ...
  function burn(CallWrapper memory self, uint256 tokenId) internal {
    ...
    bytes memory systemCall = abi.encodeCall(_burn_uint256.burn, (tokenId));
    self.from == address(0)
      ? _world().call(self.systemId, systemCall)
      : _world().callFrom(self.from, self.systemId, systemCall);
  }
...
interface _tokenURI_uint256 {
  function tokenURI(uint256 tokenId) external;
}

interface _approve_address_uint256 {
  function approve(address to, uint256 tokenId) external;
}

interface _getApproved_uint256 {
  function getApproved(uint256 tokenId) external;
}

interface _setApprovalForAll_address_bool {
  function setApprovalForAll(address operator, bool approved) external;
}

interface _isApprovedForAll_address_address {
  function isApprovedForAll(address owner, address operator) external;
}

interface _transferFrom_address_address_uint256 {
  function transferFrom(address from, address to, uint256 tokenId) external;
}

interface _safeTransferFrom_address_address_uint256 {
  function safeTransferFrom(address from, address to, uint256 tokenId) external;
}

interface _safeTransferFrom_address_address_uint256_bytes {
  function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory data) external;
}

interface _mint_address_uint256 {
  function mint(address to, uint256 tokenId) external;
}

interface _safeMint_address_uint256 {
  function safeMint(address to, uint256 tokenId) external;
}

interface _safeMint_address_uint256_bytes {
  function safeMint(address to, uint256 tokenId, bytes memory data) external;
}

interface _burn_uint256 {
