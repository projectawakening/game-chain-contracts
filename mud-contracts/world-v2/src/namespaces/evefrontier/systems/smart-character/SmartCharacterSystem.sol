...
contract SmartCharacterSystem is EveSystem {
  ...
  function createCharacter(
    ...
    EntityRecordSystemLib.createEntityRecord(entityRecordSystem, characterId, entityRecord);
    EntityRecordSystemLib.createEntityRecordMetadata(entityRecordSystem, characterId, entityRecordMetadata);
