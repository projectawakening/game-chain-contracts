...
library GlobalDeployable {
   ...
   */
  function get() internal view returns (GlobalDeployableData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get the full data.
   */
  function _get() internal view returns (GlobalDeployableData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function set(GlobalDeployableData memory _table) internal {
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(GlobalDeployableData memory _table) internal {
    bytes memory _staticData = encodeStatic(
      _table.isPaused,
      _table.updatedBlockNumber,
      _table.lastGlobalOffline,
  ...
  function decode(
    ...
    EncodedLengths,
    bytes memory
  ) internal pure returns (GlobalDeployableData memory _table) {
