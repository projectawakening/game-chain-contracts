...
interface ISmartAssemblySystem {
  ...
  function null__createSmartAssembly(
    uint256 smartObjectId,
    string memory smartAssemblyType,
    EntityRecordData memory entityRecord
  ) external;

  function null__setSmartAssemblyType(uint256 smartObjectId, string memory smartAssemblyType) external;

  function null__updateSmartAssemblyType(uint256 smartObjectId, string memory smartAssemblyType) external;
}
