...
interface ISmartTurretSystem {
  ...
  function null__createAndAnchorSmartTurret(
  ...
  function null__configureSmartTurret(uint256 smartObjectId, ResourceId systemId) external;

  function null__inProximity(
    uint256 smartObjectId,
