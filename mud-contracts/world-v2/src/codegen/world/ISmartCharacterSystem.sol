...
interface ISmartCharacterSystem {
  ...
  function null__registerCharacterToken(address tokenAddress) external;

  function null__createCharacter(
    uint256 characterId,
  ...
  function null__updateTribeId(uint256 characterId, uint256 tribeId) external;
}
