...
interface IInventorySystem {
  ...
  function null__setInventoryCapacity(uint256 smartObjectId, uint256 capacity) external;

  function null__createAndDepositItemsToInventory(uint256 smartObjectId, InventoryItem[] memory items) external;

  function null__depositToInventory(uint256 smartObjectId, InventoryItem[] memory items) external;

  function null__withdrawFromInventory(uint256 smartObjectId, InventoryItem[] memory items) external;
}
