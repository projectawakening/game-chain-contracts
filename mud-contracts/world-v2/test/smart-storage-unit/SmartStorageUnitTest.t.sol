...
contract SmartStorageUnitTest is MudTest {
  ...
  function testcreateAndAnchorSmartStorageUnit(
    ...
    SmartStorageUnitSystemLib.createAndAnchorSmartStorageUnit(
  ...
  function testCreateAndDepositItemsToInventory(
    ...
    InventorySystemLib.createAndDepositItemsToInventory(inventorySystem, smartObjectId, items);
  ...
  function testCreateAndDepositItemsToEphemeralInventory(
    ...
    EphemeralInventorySystemLib.createAndDepositItemsToEphemeralInventory(
