...
contract InventoryInteractTest is MudTest {
  ...
  function setUp() public override {
    ...
    InventorySystemLib.depositToInventory(inventorySystem, smartObjectId, invItems);
    EphemeralInventorySystemLib.depositToEphemeralInventory(ephemeralInventorySystem, smartObjectId, bob, ephInvItems);
  ...
  function testEphemeralToInventoryTransfer() public {
    ...
    vm.startPrank(bob);
    InventoryInteractSystemLib.ephemeralToInventoryTransfer(inventoryInteractSystem, smartObjectId, bob, transferItems);
    vm.stopPrank();
  ...
  function testInventoryToEphemeralTransfer() public {
    ...
    InventoryInteractSystemLib.inventoryToEphemeralTransfer(inventoryInteractSystem, smartObjectId, bob, transferItems);
    vm.stopPrank();
